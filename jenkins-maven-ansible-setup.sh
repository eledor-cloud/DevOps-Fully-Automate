...
sudo rpm --import https://pkg.jenkins.io/redhat-stable/jenkins.io.key # Note: Refer this link to change this key line frequently https://pkg.jenkins.io/redhat-stable/
sudo yum upgrade
